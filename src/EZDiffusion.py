...
class EZDiffusion:
    ...
    def distributions(R_pred, M_pred, V_pred, N):
    ...
    def simulate_and_recover(N, iterations=1000):
        ...
        for _ in range(iterations):
            ...
            R_pred, M_pred, V_pred = EZDiffusion.forward(v_true, a_true, t_true)

            R_obs, M_obs, V_obs = EZDiffusion.distributions(R_pred, M_pred, V_pred, N)

            v_est, a_est, t_est = EZDiffusion.inverse(R_obs, M_obs, V_obs)
